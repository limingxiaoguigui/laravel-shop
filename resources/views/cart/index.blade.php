    ...
    <div>
        <form class="form-horizontal" role="form" id="order-form">
            <div class="form-group row">
                <label class="col-form-lable col-sm-3 text-md-right">选择收货地址</label>
            ...
            <div class="form-group row">
                <label class="col-form-lable col-sm-3 text-md-right">备注</label>
                <div class="col-sm-9 col-md-7">
...
<script>
    $(document).ready(function(){
        ...
        $('.btn-remove').click(function(){
            //$(this)可以获取到当前点击的移除按钮的jq对象
            //closest()方法可以获取到匹配选择器的第一个祖先元素，在这里就是当前点击移除按钮只上的？<tr></tr>标签
            //data('id')方法可以获取到我们之前设置的data-id属性的值，也就是队形的 sku_id的值
            ...
            swal({
                ...
                //用户点击确定按钮。willDelete的值就会是true否则为false
                if(!willDelete){
                    return;
                }
